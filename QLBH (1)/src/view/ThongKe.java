...
public class ThongKe extends javax.swing.JPanel {
    ...
    private List<HoaDonChiTietAn> chiTiets = tksi.getListTK();
...
////        BigDecimal dt = tksi.getListDoangThu();
    ...
    private void loadTB() {
        List<HoaDonChiTietAn> chiTiets = tksi.getListTK();
        model = (DefaultTableModel) tblThongKe.getModel();
        model.setRowCount(0);
        for (HoaDonChiTietAn x : chiTiets) {
            Object row[] = new Object[]{
                x.getTenSP(), x.getHoaDonBan(), x.getSoLuongBanRa(), formatter.format(x.getMaSP().getGiaNhap()), formatter.format(x.getMaSP().getGiaBan()), formatter.format(x.getThanhtien())
            };
            model.addRow(row);
        }
    }
    ...
    private void loadTBDoanhThu() {
        List<HoaDonChiTietAn> chiTiets = tksi.searchDoanhThu();
        model = (DefaultTableModel) tblThongKe.getModel();
        model.setRowCount(0);
        for (HoaDonChiTietAn x : chiTiets) {
            Object row[] = new Object[]{
    ...
    private void loadTBHoaDon() {
        List<HoaDonChiTietAn> chiTiets = tksi.searchHoaDon();
        model = (DefaultTableModel) tblThongKe.getModel();
        model.setRowCount(0);
        for (HoaDonChiTietAn x : chiTiets) {
            Object row[] = new Object[]{
    ...
    private void loadTBSoLuong() {
        List<HoaDonChiTietAn> chiTiets = tksi.searchSoLuong();
        model = (DefaultTableModel) tblThongKe.getModel();
        model.setRowCount(0);
        for (HoaDonChiTietAn x : chiTiets) {
            Object row[] = new Object[]{
    ...
    private void initComponents() {
        ...
        tblThongKe.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sản phẩm", "Số hóa đơn Chi Tiết", "Số lượng", "Giá nhập", "Giá bán", "Tổng tiền"
            }
        ));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(lblHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(15, 15, 15))
        );
        ...
        rboHoaDon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rboHoaDonActionPerformed(evt);
            }
        });
...
//        // TODO add your handling code here:
    ...
    private void txtTenspKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTenspKeyReleased
        ...
        if (txtTensp.getText().length() == 0) {
            ...
            List<HoaDonChiTietAn> chiTiets = tksi.searchTenSP(txtTensp.getText());
            model = (DefaultTableModel) tblThongKe.getModel();
            model.setRowCount(0);
            for (HoaDonChiTietAn x : chiTiets) {
                Object row[] = new Object[]{
...
//        }
    ...
    private void rboHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rboHoaDonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rboHoaDonActionPerformed
